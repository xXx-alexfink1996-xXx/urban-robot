...
struct MonSpritesGfxManager	//Summary Screen for EWRAM DATA
{
    u8 numSprites;
    u8 numFrames;
    bool16 active;
...
struct MonSpritesGfxManager *CreateMonSpritesGfxManager(void);	//Summary Screen for EWRAM DATA
void DestroyMonSpritesGfxManager(void);	//Summary Screen for EWRAM DATA
u8 *MonSpritesGfxManager_GetSpritePtr(u8 spriteNum);	//Summary Screen for EWRAM DATA
