...
static u8 ChooseWildMonIndex_Land(void)
{
    ...
    if (rand < ENCOUNTER_CHANCE_LAND_MONS_SLOT_0)
        ...
        return 9;
    else if (rand >= ENCOUNTER_CHANCE_LAND_MONS_SLOT_9 && rand < ENCOUNTER_CHANCE_LAND_MONS_SLOT_10)	//pokemon encounter ratio fix
        return 10;
    else
        return 11;
}
...
static u8 ChooseWildMonIndex_Fishing(u8 rod)
{
    ...
    case SUPER_ROD:
        ...
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_7 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_8)
            wildMonIndex = 8;
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_8 && rand < ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_9)	//pokemon encounter ratio fix
            wildMonIndex = 9;
        break;
    }
    return wildMonIndex;
