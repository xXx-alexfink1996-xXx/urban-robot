...
//static u8 GetDirectionFromBitfield(u8 bitfield)	//Change Direction While Moving
//static void SetDirectionFromHeldKeys(u16 heldKeys)	//Change Direction While Moving
