...
EWRAM_DATA static struct MonSpritesGfxManager *sMonSpritesGfxManager = NULL;	//Summary Screen EWRAM DATA
...
{
    if (gMonSpritesGfxPtr != NULL)	//Summary Screen for EWRAM DATA
...
#define GFX_MANAGER_NUM_FRAMES 2  // Only 2 frames are needed	//Summary Screen for EWRAM DATA

static void InitMonSpritesGfx_Battle(struct MonSpritesGfxManager* gfx)
{
    u32 i, j;	//Summary Screen for EWRAM DATA
