...
#endif
{
	...
	//Battle Terrain Loading Improvement
...
static u8 GetBattleTerrainOverride(void);	//Battle Terrain Loading Improvement
...
{
    LoadBattleTerrainGfx(GetBattleTerrainOverride());	//Battle Terrain Loading Improvement
}
